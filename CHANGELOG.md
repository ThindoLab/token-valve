...
- Added the Phase 18 Skill Orchestration MVP with provider onboarding plans, safe MCP call drafts, local-only credential guidance, verification-gated recipe saving, and secret-like input rejection.
- Added the Phase 18 feature spec covering Skill orchestration requirements, implementation plan, and validation checklist.
...
- Added the Phase 2 feature spec covering resolver requirements, implementation plan, and validation checklist.
- Added the Phase 1 project skeleton with a pnpm TypeScript monorepo, package shells, minimal CLI, tests, linting, and build configuration.
- Added the Phase 1 feature spec covering requirements, implementation plan, and validation checklist.
